...
abstract class PaymentGateway
{
     ...
     * @var string
     */
    protected $pathViews = 'application.views.backend.payment';
     ...
     * @var string
     */
    protected $pathLayouts = 'application.views.layouts';
    ...
    public function submitPayment()
    {
        ...
        $view='payment';
        $layout='payment';
        $vars=array_merge(array('fields'=>$this->fields),array('gatewayUrl'=>$this->gatewayUrl));
        $body=Yii::app()->controller->renderPartial($this->pathViews.'.'.$view, array_merge($vars, array('content'=>$body)), true);
        Yii::app()->controller->renderPartial($this->pathLayouts.'.'.$layout, array('content'=>$body));
    }
